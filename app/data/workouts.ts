...
const V: Record<string, string> = {
  ...
  'Triceps Dips': '2z8Jmcr5-2c',
  'Pistol Squats': 'tAlTGKI4ovA',
  'Walking Lunges': 'QOVaHwm-Q6U',
  'Single-Leg Hip Thrusts': 'iNw0RB6YFAY',
};
  ...
  return {
    monday: {
      ...
      exercises: [
        ...
        mon.ex({ name: 'Pull-ups', sets: 4, reps: p.pullReps, videoId: vid('Pull-ups'), notes: 'Stop 1-2 reps before failure. Mix grips.' }),
        mon.ex({ name: 'Pike Push-ups', sets: 3, reps: '8', videoId: vid('Pike Push-ups'), notes: 'Hips high, head lowers toward floor — builds OHP strength without weights.' }),
        mon.ex({ name: 'Triceps Dips', sets: 3, reps: '8-12', videoId: vid('Triceps Dips'), notes: 'On chair/bench/parallel bars. Full depth, lock out at top.' }),
        ...
        mon.ex({ name: 'PT Reset', reps: '2 rounds', notes: 'Reverse push-ups x20, arm haulers x20, birds x20, swimmers x30s, plank 1 min. Stew Smith cooldown.' }),
      ],
    },
    tuesday: {
    ...
    wednesday: {
      ...
      exercises: [
        ...
        wed.ex({ name: 'Pistol Squat Progression', sets: 4, reps: '5/leg', videoId: vid('Pistol Squats'), notes: 'Assisted (hold doorframe) → unassisted → full depth.' }),
        wed.ex({ name: 'Bodyweight Squats', sets: 4, reps: p.gobletReps, videoId: vid('Air Squats'), notes: 'Full depth, controlled tempo (3s down, 1s up).' }),
        wed.ex({ name: 'Walking Lunges', sets: 3, reps: '12/leg', videoId: vid('Walking Lunges'), notes: 'Long stride, back knee kisses floor.' }),
        wed.ex({ name: 'Single-Leg Hip Thrusts', sets: 3, reps: '10/leg', videoId: vid('Single-Leg Hip Thrusts'), notes: 'Upper back on chair, drive through HEEL.' }),
    ...
    friday: {
      ...
      exercises: [
        ...
        fri.ex({ name: 'Pull-ups', sets: 4, reps: 'max (stop 1-2 before failure)', videoId: vid('Pull-ups'), notes: 'Rest 2 min between sets. This is strength, not conditioning.' }),
        fri.ex({ name: `Work Capacity Circuit (${p.wcRounds} rounds, target <25 min)`,
          notes: 'Bodyweight squats x20 → 10 burpees → 15 push-ups → 20m bear crawl. Minimal rest between stations.' }),
        fri.ex({ name: 'Bodyweight Squats', reps: '20', videoId: vid('Air Squats') }),
        fri.ex({ name: 'Burpees', reps: '10', videoId: vid('Burpees') }),
        fri.ex({ name: 'Push-ups', reps: '15', videoId: vid('Push-ups') }),
